...
//    ";
    ...
    //    var (attemptAfterGreens, x) = evaluateGreens(attempt, target);
    //    return evaluateYellows(evaluateGreens(attempt, target).attempt, evaluateGreens(attempt, target).target).attempt;
    //  }
    //}";
