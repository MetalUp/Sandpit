...
public static class ASTHelpers {
    private static readonly IDictionary<string, string> TokenToTypeDict = new Dictionary<string, string> { { Constants.LITERAL_INTEGER_TOKEN, Constants.Bacon_Integer }, { "STRING", "String" } };
